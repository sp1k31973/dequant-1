/* src/config/dequant-config.h.  Generated from dequant-config.h.in by configure.  */
/* src/config/dequant-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.beherocoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BHN Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BHN Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bhncore"
