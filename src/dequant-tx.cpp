...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dequant Core dequant-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dequant-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Dequant Core transaction") + "\n" +
                               "  dequant-tx [options] -create [commands]   " + _("Create hex-encoded Dequant Core transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Dequant Core transaction
