...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DEQ address"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dequant Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DEQ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DEQ addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Dequant Core help message to get a list with possible Dequant Core command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dequant Core network", "", count));
}
