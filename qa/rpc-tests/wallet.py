...
#   c) node1 mines 32 blocks, so now node 0 has 500000BHN, node 1 has 4250BHN, node2 has none.
#   d) node0 sends 601 BHN to node2, in two transactions (301 BHN, then 300 BHN).
