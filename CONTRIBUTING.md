...
confused with overall Dequant Core Network Protocol consensus changes.
...
Patches that change Dequant Core consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dequant Core consensus, it must have been
