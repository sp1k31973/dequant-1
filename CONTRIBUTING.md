Contributing to BHN Core
==================================

The BHN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BHN Core project, and is not to be
confused with overall BHN Core Network Protocol consensus changes.

Whether a pull request is merged into BHN Core rests with the project merge
...
Patches that change BHN Core consensus rules are considerably more involved than
...
Where a patch set proposes to change the BHN Core consensus, it must have been
...
The project leader is the release manager for each BHN Core release.
