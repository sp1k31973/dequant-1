...
This mechanism has been integrated into Bitcore-Node-BhnCore which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bhncore/insight-api-bhncore#web-socket-api](https://github.com/bhncore/insight-api-bhncore#web-socket-api)
* API: [https://github.com/bhncore/insight-api-bhncore#swifttx-transactions](https://github.com/bhncore/insight-api-bhncore#swifttx-transactions)
...
By default, the BHN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BHN Core daemon:
