...
In order to support loading of multiple wallets in bhncore-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bhncore.cpp.
...
Changes to bhncore.cpp
----------------------
bhncore.cpp is the entry point into bhncore-qt, and as such, will require some minor modifications to provide hooks for
