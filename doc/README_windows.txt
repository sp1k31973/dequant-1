...
Intro
-----
BHN Core (BHN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BHN Core utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run bhncore-qt.exe.

BHN Core is the original BHN Core client and it builds the backbone of the network.
However, it downloads and stores the entire history of BHN Core transactions;
